...
def define_flightline_search_before(db):

    class Plat_flightline_search_before(db.Entity):
        ...
        ahead_total = Optional(int, sql_type="int(11)")
    ...
    return Plat_flightline_search_before