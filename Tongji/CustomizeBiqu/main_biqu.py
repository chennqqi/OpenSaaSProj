...
if __name__ == "__main__":
    ...
    if "appoint" in sys.argv:
        ...
        for i in [27,]:
            ...
            process.storeappointbydaily(i, "jh_10a0e81221095bdba91f7688941948a6", "BIQU_ANDROID", "android", "custom_hx_searchbefore", ifdel=True, ifclearresult=True)
